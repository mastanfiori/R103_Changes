sap.ui.define([
	"sap/ui/test/Opa5",
	"com/sugarcreek/R103_Quality_Notif/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.sugarcreek.R103_Quality_Notif.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ItQnotifSelSet/" + sObjectId;
