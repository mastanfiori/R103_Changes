...
sap.ui.define([
	...
	"com/sugarcreek/R103_Quality_Notif/test/flpSandbox"
	...
	return Opa5.extend("com.sugarcreek.R103_Quality_Notif.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ItQnotifSelSet/" + encodeURIComponent(sObjectId);
